# DIN Rail MEGA Fuse Holder | M8, 50.8 mm Pitch, 1.5 Modules

Mount a MEGA fuse vertically across a 35 mm DIN rail. This compact holder is 27 mm wide (1.5 modules), with two M8 studs at 50.8 mm centres for the fuse and cable lugs, for example in Victron Energy systems.
...
Print the parts on their supplied sides. Suggested starting settings: 0.4 mm nozzle, 0.20 mm layers, Arachne, 6 walls, 60% gyroid infill, supports off. The included Bambu Studio project is for X1 Carbon / Generic PLA. The extended hooks need a fit check on the actual rail.
